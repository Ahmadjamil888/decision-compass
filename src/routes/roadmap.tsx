...
export const Route = createFileRoute("/roadmap")({
  ...
  head: () => ({
    meta: [
      { title: "How IMOS evolves — Institutional Memory OS" },
      {
        name: "description",
        content:
          "Six phases, each delivering real value. From decision extraction today to PR-level insights and offboarding intelligence.",
      },
    ],
  }),
});
...
function RoadmapPage() {
  ...
  return (
    <Shell>
      {/* The moment IMOS clicks — hero pull-quote */}
      <section className="mb-16">
        <BlueprintCard className="border-primary/30 bg-gradient-to-br from-primary/5 to-transparent">
          ...
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-muted-foreground">
            ...
            engineer is operating blind on legacy code — re-litigating decisions
            that were made years ago, breaking constraints no one remembers.
          </p>
        </BlueprintCard>
      </section>
